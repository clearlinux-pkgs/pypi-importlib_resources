...
Version  : 6.1.3
Release  : 39
URL      : https://files.pythonhosted.org/packages/6d/74/cbe48855681fdc7369f6e605a86f286989ec837ed83a9df237140ac27a27/importlib_resources-6.1.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/6d/74/cbe48855681fdc7369f6e605a86f286989ec837ed83a9df237140ac27a27/importlib_resources-6.1.3.tar.gz
...
%prep
%setup -q -n importlib_resources-6.1.3
cd %{_builddir}/importlib_resources-6.1.3
pushd ..
cp -a importlib_resources-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709826863
