...
Version  : 6.3.0
Release  : 40
URL      : https://files.pythonhosted.org/packages/47/09/c02a7de10bd37af6752d1487b989342e4ae688a0082c59d3fc16274361c7/importlib_resources-6.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/47/09/c02a7de10bd37af6752d1487b989342e4ae688a0082c59d3fc16274361c7/importlib_resources-6.3.0.tar.gz
...
%prep
%setup -q -n importlib_resources-6.3.0
cd %{_builddir}/importlib_resources-6.3.0
pushd ..
cp -a importlib_resources-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710540004
